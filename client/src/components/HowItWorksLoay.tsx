...
const whatsappMessage = "مرحبا! بدي اشترك بتحدي الكوتش لؤي";
        ...
        <div className="mx-auto grid max-w-4xl gap-6 lg:grid-cols-2">
          ...
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.94 }}
              className="relative flex h-20 w-20 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_0_30px_rgba(37,211,102,0.38)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 focus-visible:ring-offset-background"
            >
