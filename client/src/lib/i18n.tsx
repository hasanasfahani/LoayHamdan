...
const translations = {
  ...
  en: {
    ...
    how: {
      ...
      whatsapp: "Click the WhatsApp button and send: “I want to join.” Our team will guide you through payment and help you join the challenge. (Subscription price: $29.9)",
