...
const translations = {
  ...
  en: {
    ...
    how: {
      ...
      whatsapp: "Click the WhatsApp button to subscribe, and our team will contact you to confirm your registration.",
      whatsappFomo: "10 spots left",
